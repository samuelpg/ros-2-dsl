...
public final class AddRequirementsAnnotationToOperations_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public AddRequirementsAnnotationToOperations_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:186844af-000e-4714-9838-4712fa7d54ad(ROS2.intentions)", "219695718624493633"));
  }
  @Override
  public String getPresentation() {
    return "AddRequirementsAnnotationToOperations";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      if ((AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(CONCEPTS.RequirementsProfileAnnotation$Ul)) == null)) {
        AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute(CONCEPTS.RequirementsProfileAnnotation$Ul), createRequirementsProfileAnnotation_jmhd8z_a0a0a0a0());
      } else {
    ...
    public IntentionDescriptor getDescriptor() {
      return AddRequirementsAnnotationToOperations_Intention.this;
    }
  }
  private static SNode createRequirementsProfileAnnotation_jmhd8z_a0a0a0a0() {
