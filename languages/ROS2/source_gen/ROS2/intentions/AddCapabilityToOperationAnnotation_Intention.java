...
public final class AddCapabilityToOperationAnnotation_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public AddCapabilityToOperationAnnotation_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:186844af-000e-4714-9838-4712fa7d54ad(ROS2.intentions)", "8252408901306002533"));
  }
  @Override
  public String getPresentation() {
    return "AddCapabilityToOperationAnnotation";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      if ((AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(CONCEPTS.CapabilityProfileAnnotation$9I)) == null)) {
        AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute(CONCEPTS.CapabilityProfileAnnotation$9I), createCapabilityProfileAnnotation_vx703l_a0a0a0a0());
      } else {
    ...
    public IntentionDescriptor getDescriptor() {
      return AddCapabilityToOperationAnnotation_Intention.this;
    }
  }
  private static SNode createCapabilityProfileAnnotation_vx703l_a0a0a0a0() {
