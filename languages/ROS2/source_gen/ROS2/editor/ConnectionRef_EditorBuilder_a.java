...
/*package*/ class ConnectionRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConnectionRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_e58dnv_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_e58dnv_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.ref$KktL;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.ref$KktL);
    }
